...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Gaard_Paula_Eg_havi_v_l_loyvi_at_liva_.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Eg havi væl loyvi at liva. Náttúrufatanir og vistkritikkur í føroyskum og norðurlendskum barna- og ungdómsbókmentum'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Paula"/>
    <xsl:variable name="author1_ln" select="'Gaard''"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Sanna"/>
    <xsl:variable name="author2_ln" select="'Andrassdóttir Dahl'"/>
    ...
    <!-- Automatically filled in by CorpusTools -->
    <xsl:variable name="mainlang" select="'fao'"/>
