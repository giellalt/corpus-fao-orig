...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'Fiskirannsoknir_1.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Royndarfiskiskapur eftir sild við nót i januar - mars 1965'"/>
    <!--
    ...
    <!-- Publication year -->
    <xsl:variable name="year" select="'1966'"/>
